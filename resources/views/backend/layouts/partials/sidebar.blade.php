   <!-- Sidebar -->
        ...
        <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" class="p-3 mb-2 bg-secondary text-white" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('admin.books.unapproved') }}">Unapproved Books
